...
> 관련 문서: [ARCHITECTURE.md](https://github.com/NET-Challenge-S13/skylens/blob/develop/docs/ARCHITECTURE.md) §3-A (모델·융합 파이프라인) ·
> [DATASETS.md](https://github.com/NET-Challenge-S13/skylens/blob/develop/docs/DATASETS.md) (데이터셋 조사) · [INTENT.md](https://github.com/NET-Challenge-S13/skylens/blob/develop/docs/INTENT.md) (기획)
...
- 시계열 모델(3D conv, temporal attention)은 무겁고 데이터를 훨씬 많이 요구하는데,
  우리는 [DATASETS.md](https://github.com/NET-Challenge-S13/skylens/blob/develop/docs/DATASETS.md)에서 확인했듯 데이터가 부족하고 파편화돼 있다.
