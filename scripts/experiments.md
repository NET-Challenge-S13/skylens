...
```
python scripts/train_experiment.py --run-name combo-pos-weight --epochs 5 --road-oversample 4 --balance-fire-seg --dice-loss-weight 1.0 --visdrone-tiles --offset-head --sard tiles --person-head-stride 2 --radius-rounding round --heatmap-pos-weight 4.0 --num-workers 8
```

## combo-balance-seg

```
python scripts/train_experiment.py --run-name combo-balance-seg --epochs 5 --road-oversample 4 --balance-fire-seg --dice-loss-weight 1.0 --visdrone-tiles --offset-head --sard tiles --person-head-stride 2 --radius-rounding round --heatmap-pos-weight 4.0 --seg-loss-weight 2.0 --num-workers 8
```
