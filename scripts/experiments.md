...
```
python scripts/train_experiment.py --run-name holdout-sard --epochs 5 --road-oversample 4 --balance-fire-seg --dice-loss-weight 1.0 --visdrone-tiles --offset-head --sard off --num-workers 8
```
