...
## person-min-gaussian-radius

```
python scripts/train_experiment.py --run-name person-min-gaussian-radius --epochs 5 --road-oversample 4 --balance-fire-seg --dice-loss-weight 1.0 --visdrone-tiles --offset-head --min-gaussian-radius 1 --num-workers 8
```
