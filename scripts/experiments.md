...
## person-heatmap-source-norm

```
python scripts/train_experiment.py --run-name person-heatmap-source-norm --epochs 5 --road-oversample 4 --balance-fire-seg --dice-loss-weight 1.0 --visdrone-tiles --offset-head --heatmap-norm per-sample --num-workers 8
```
